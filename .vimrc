...
"Plugin 'breestealth/Mark-Karkat'
...
Plugin 'vim-scripts/taglist.vim' " 使用Tagbar替代 更适合C++
Plugin 'TxtBrowser'
Plugin 'winmanager'
Plugin 'ZoomWin'
...
nnoremap <F8> @=((foldclosed(line('.')) < 0) ? 'zM' : 'zR')<CR>
" 当文件在外部被修改，自动更新该文件
set autoread
...
" 设置代码配色方案
"if g:isGUI
"    colorscheme molokai"Tomorrow-Night-Eighties               "Gvim配色方案
"else
"    colorscheme molokai"Tomorrow-Night-Eighties               "终端配色方案
"endif
